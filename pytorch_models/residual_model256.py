...
class Model(nn.Module):
    def __init__(self):
        ...
        self.conv5 = nn.Conv2d(256, 256, kernel_size=(4, 4))
        self.batchnorm5 = nn.BatchNorm2d(256)

        self.maxpool3x3 = nn.MaxPool2d(3)
        self.maxpool2x2 = nn.MaxPool2d(2)

        self.dense1 = nn.Linear(256*2*2, 50)
        self.dense2 = nn.Linear(50, 256*2*2)

        """ target-decoder """

        self.targetDeconv1 = nn.ConvTranspose2d(256, 256, kernel_size=(4, 4))
        ...
        self.sourceDeconv1 = nn.ConvTranspose2d(256, 256, kernel_size=(4, 4))
    ...
    def _gaussian_noise_layer(self, x, fixed_gaussian_noise_rate=False):
        gaussian_noise_rate = np.random.choice([0.03, 0.05, 0.0, 0.0, 0.02, 0.02])
    ...
    def forward(self, x, label: str="0", visualize: bool=False, print_: bool=False, mode: str="train"):
        if mode == "train":
            ...
            x = self._gaussian_noise_layer(x, fixed_gaussian_noise_rate=0.01)
